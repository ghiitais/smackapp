...
class AuthService { //singleton
    ...
    let defaults = UserDefaults.standard //store simple values like booleans, emails..
    //variables persisted across app launch
    ...
    func findUserByEmail(completion: @escaping CompletionHandler) {
        Alamofire.request("\(URL_USER_BY_EMAIL)\(userEmail)", method: .get
